    ...
    function refreshJobs() {
        PanUtil.ajax.get("/m3u8/getJobs", {}, function (re) {
            ...
            for(var k in re.data){
                var it=re.data[k];
                arr.push([
                    "<tr><td colspan='2'>"+it.from+"</td></tr>",
                    "<tr><td>下载路径</td><td>"+it.dir+"/"+it.file+"</td></tr>",
                    "<tr><td>工作线程</td><td>"+it.active+"</td></tr>",
                    "<tr><td>总时长</td><td>"+Math.round(it.duringSum)+"</td></tr>",
                    "<tr><td>完成时长</td><td>"+Math.round(it.duringAlready)+"</td></tr>",
                    "<tr><td>总大小</td><td>"+it.length+"</td></tr>",
                    "<tr><td>完成大小</td><td>"+it.complete+"</td></tr>",
