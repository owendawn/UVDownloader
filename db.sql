...
create table if not exists user(id int(25) PRIMARY key auto_increment,name VARCHAR(20) not null,pwd VARCHAR(50),dept int(25))
...
insert into user(name,pwd ,dept) values('测试','123',4);
